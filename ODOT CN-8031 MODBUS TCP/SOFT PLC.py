...
def Read_analog_input():
    ...
    AI0 = IO49.Read_holding_register_uint16(Register_address = 16384)
    AI1 = IO49.Read_holding_register_uint16(Register_address = 16385)
    AI2 = IO49.Read_holding_register_uint16(Register_address = 16386)
    AI3 = IO49.Read_holding_register_uint16(Register_address = 16387)
    AI4 = IO49.Read_holding_register_uint16(Register_address = 16388)
    AI5 = IO49.Read_holding_register_uint16(Register_address = 16389)
    AI6 = IO49.Read_holding_register_uint16(Register_address = 16390)
    AI7 = IO49.Read_holding_register_uint16(Register_address = 16391)
    IO49_S3_Ai0 = (((float(AI0) / 27648.0) * 16.0) + 4.0) * float((AI0 != 0x7FFF) and (AI0 != 0x8000)) # 4...20мА
    IO49_S3_Ai1 = (((float(AI1) / 27648.0) * 16.0) + 4.0) * float((AI1 != 0x7FFF) and (AI1 != 0x8000)) # 4...20мА
    IO49_S3_Ai2 = (((float(AI2) / 27648.0) * 16.0) + 4.0) * float((AI2 != 0x7FFF) and (AI2 != 0x8000)) # 4...20мА
    IO49_S3_Ai3 = (((float(AI3) / 27648.0) * 16.0) + 4.0) * float((AI3 != 0x7FFF) and (AI3 != 0x8000)) # 4...20мА
    IO49_S3_Ai4 = (((float(AI4) / 27648.0) * 16.0) + 4.0) * float((AI4 != 0x7FFF) and (AI4 != 0x8000)) # 4...20мА
    IO49_S3_Ai5 = (((float(AI5) / 27648.0) * 16.0) + 4.0) * float((AI5 != 0x7FFF) and (AI5 != 0x8000)) # 4...20мА
    IO49_S3_Ai6 = (((float(AI6) / 27648.0) * 16.0) + 4.0) * float((AI6 != 0x7FFF) and (AI6 != 0x8000)) # 4...20мА
    IO49_S3_Ai7 = (((float(AI7) / 27648.0) * 16.0) + 4.0) * float((AI7 != 0x7FFF) and (AI7 != 0x8000)) # 4...20мА
...
def Write_analog_output():
    ...
    AO1 = 0 #0...27648 -> 4...20mA
    AO2 = 0 #0...27648 -> 4...20mA
    AO3 = 0 #0...27648 -> 4...20mA
    IO49.Write_multiple_holding_register_uint16(Register_address = 0, Register_value = AO0)
    IO49.Write_multiple_holding_register_uint16(Register_address = 1, Register_value = AO1)
    IO49.Write_multiple_holding_register_uint16(Register_address = 2, Register_value = AO2)
    IO49.Write_multiple_holding_register_uint16(Register_address = 3, Register_value = AO3)
    return
